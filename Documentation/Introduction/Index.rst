...
- Attach an automatic generated link to Google Maps to the content of
  the InfoWindow
...
*Example of a styled map with one individual marker and
automatic generated link in the InfoWindow, input and submit button to
calculate route*
